---
layout: tool
title: "AP World History Score Calculator | AP World Modern Curve"
description: "Calculate your AP World History exam grade (1–5) based on multiple-choice, SAQ, DBQ, and LEQ section points."
permalink: /ap-world-history-score-calculator
tool_id: ap-world-history-score-calculator
category: ap-scores
hide_sidebar: true
...
js_file: assets/js/calculators/ap-world-history-score-calculator.js
...
breadcrumb:
  ...
  - name: Education
    url: /education
  - name: "AP World History Calculator"

howto:
  name: "How to Calculate Your AP World History: Modern AP Score"
  description: "Use your section scores to estimate your official 1-5 AP score for AP World History: Modern."
  step:
...
faq:
  - question: "How is the AP World History: Modern AP score calculated?"
    answer: "The AP World History: Modern AP score combines your weighted Section 1 (Multiple-Choice) and Section 2 (Free-Response) points into a composite score out of 100. This composite score is mapped to a 1–5 AP grade based on College Board scoring curves."
...
# AP World History Score Calculator | AP World Modern Curve

Calculate your AP World History exam grade (1–5) based on multiple-choice, SAQ, DBQ, and LEQ section points. Calculate your composite score and see if you are on track for a 3, 4, or 5 — 100% free and private in your browser.

<!-- more -->

## How AP World History: Modern Exam Scoring Works

The **AP World History: Modern** exam consists of multiple sections that are weighted to produce a composite score out of **100**. College Board converts this composite score into a scaled AP score from **1 to 5**:

- **5 (Extremely Well Qualified)**: Composite score of 72+
- **4 (Well Qualified)**: Composite score of 60 – 71
- **3 (Qualified)**: Composite score of 48 – 59
- **2 (Possibly Qualified)**: Composite score of 36 – 47
...
### How is the AP World History: Modern AP score calculated?
The AP World History: Modern AP exam score combines your weighted Multiple-Choice and Free-Response section points into a total composite score out of 100, which maps to a 1–5 AP grade based on College Board scoring curves.
