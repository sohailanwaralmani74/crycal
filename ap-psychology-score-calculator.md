---
layout: tool
title: "AP Psychology Score Calculator | Calculate AP Psych Grade"
description: "Calculate your estimated AP Psychology exam grade (1–5) based on multiple-choice and FRQ raw points."
permalink: /ap-psychology-score-calculator
tool_id: ap-psychology-score-calculator
category: ap-scores
hide_sidebar: true

inputs:
  - id: mcq
    label: "Multiple Choice Correct (out of 75)"
    type: number
    default: 58
    min: 0
    max: 75
    ...
    placeholder: "e.g., 58"
  - id: frq
    label: "Free Response Points (out of 14)"
    type: number
    default: 10
    min: 0
    max: 14
...
js_file: assets/js/calculators/ap-psychology-score-calculator.js
...
howto:
  name: "How to Calculate Your AP Psychology AP Score"
  description: "Use your section scores to estimate your official 1-5 AP score for AP Psychology."
  step:
...
faq:
  - question: "How is the AP Psychology AP score calculated?"
    answer: "The AP Psychology AP score combines your weighted Section 1 (Multiple-Choice) and Section 2 (Free-Response) points into a composite score out of 150. This composite score is mapped to a 1–5 AP grade based on College Board scoring curves."
...
# AP Psychology Score Calculator | Calculate AP Psych Grade

Calculate your estimated AP Psychology exam grade (1–5) based on multiple-choice and FRQ raw points. Calculate your composite score and see if you are on track for a 3, 4, or 5 — 100% free and private in your browser.

<!-- more -->

## How AP Psychology Exam Scoring Works

The **AP Psychology** exam consists of multiple sections that are weighted to produce a composite score out of **150**. College Board converts this composite score into a scaled AP score from **1 to 5**:

- **5 (Extremely Well Qualified)**: Composite score of 110+
- **4 (Well Qualified)**: Composite score of 92 – 109
- **3 (Qualified)**: Composite score of 77 – 91
- **2 (Possibly Qualified)**: Composite score of 62 – 76
- **1 (No Recommendation)**: Composite score of 0 – 61

## Section Weighting Breakdown

| Section | Format | Max Raw Points | Weight % | Max Composite Points |
|---|---|---|---|---|
| Section I | Multiple Choice (75 Questions) | 75 | 66.7% | 100 |
| Section II | Free Response (2 Questions) | 14 | 33.3% | 50 |
...
### How is the AP Psychology AP score calculated?
The AP Psychology AP exam score combines your weighted Multiple-Choice and Free-Response section points into a total composite score out of 150, which maps to a 1–5 AP grade based on College Board scoring curves.
