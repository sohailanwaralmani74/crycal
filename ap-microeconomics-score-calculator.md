---
layout: tool
title: "AP Microeconomics Score Calculator | Estimate AP Micro Grade"
description: "Calculate your AP Microeconomics composite score and 1–5 grade based on 60 MCQ questions and 3 FRQ questions."
permalink: /ap-microeconomics-score-calculator
tool_id: ap-microeconomics-score-calculator
category: ap-scores
hide_sidebar: true
...
js_file: assets/js/calculators/ap-microeconomics-score-calculator.js
...
breadcrumb:
  ...
  - name: Education
    url: /education
  - name: "AP Microeconomics Calculator"

howto:
  name: "How to Calculate Your AP Microeconomics AP Score"
  description: "Use your section scores to estimate your official 1-5 AP score for AP Microeconomics."
  step:
...
faq:
  - question: "How is the AP Microeconomics AP score calculated?"
    answer: "The AP Microeconomics AP score combines your weighted Section 1 (Multiple-Choice) and Section 2 (Free-Response) points into a composite score out of 90. This composite score is mapped to a 1–5 AP grade based on College Board scoring curves."
...
# AP Microeconomics Score Calculator | Estimate AP Micro Grade

Calculate your AP Microeconomics composite score and 1–5 grade based on 60 MCQ questions and 3 FRQ questions. Calculate your composite score and see if you are on track for a 3, 4, or 5 — 100% free and private in your browser.

<!-- more -->

## How AP Microeconomics Exam Scoring Works

The **AP Microeconomics** exam consists of multiple sections that are weighted to produce a composite score out of **90**. College Board converts this composite score into a scaled AP score from **1 to 5**:
...
### How is the AP Microeconomics AP score calculated?
The AP Microeconomics AP exam score combines your weighted Multiple-Choice and Free-Response section points into a total composite score out of 90, which maps to a 1–5 AP grade based on College Board scoring curves.
