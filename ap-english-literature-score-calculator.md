---
layout: tool
title: "AP English Literature Score Calculator | AP Lit Estimator"
description: "Calculate your AP English Literature & Composition exam score (1–5) based on multiple-choice performance and essay scores."
permalink: /ap-english-literature-score-calculator
tool_id: ap-english-literature-score-calculator
category: ap-scores
hide_sidebar: true
...
js_file: assets/js/calculators/ap-english-literature-score-calculator.js
...
breadcrumb:
  ...
  - name: Education
    url: /education
  - name: "AP English Literature Calculator"

howto:
  name: "How to Calculate Your AP English Literature AP Score"
  description: "Use your section scores to estimate your official 1-5 AP score for AP English Literature."
  step:
...
faq:
  - question: "How is the AP English Literature AP score calculated?"
    answer: "The AP English Literature AP score combines your weighted Section 1 (Multiple-Choice) and Section 2 (Free-Response) points into a composite score out of 100. This composite score is mapped to a 1–5 AP grade based on College Board scoring curves."
...
# AP English Literature Score Calculator | AP Lit Estimator

Calculate your AP English Literature & Composition exam score (1–5) based on multiple-choice performance and essay scores. Calculate your composite score and see if you are on track for a 3, 4, or 5 — 100% free and private in your browser.

<!-- more -->

## How AP English Literature Exam Scoring Works

The **AP English Literature** exam consists of multiple sections that are weighted to produce a composite score out of **100**. College Board converts this composite score into a scaled AP score from **1 to 5**:

- **5 (Extremely Well Qualified)**: Composite score of 74+
- **4 (Well Qualified)**: Composite score of 62 – 73
- **3 (Qualified)**: Composite score of 50 – 61
- **2 (Possibly Qualified)**: Composite score of 37 – 49
- **1 (No Recommendation)**: Composite score of 0 – 36

## Section Weighting Breakdown

| Section | Format | Max Raw Points | Weight % | Max Composite Points |
|---|---|---|---|---|
| Section I | Multiple Choice (55 Questions) | 55 | 45% | 45 |
...
### How is the AP English Literature AP score calculated?
The AP English Literature AP exam score combines your weighted Multiple-Choice and Free-Response section points into a total composite score out of 100, which maps to a 1–5 AP grade based on College Board scoring curves.
