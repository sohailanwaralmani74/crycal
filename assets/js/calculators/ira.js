...
(function() {
  ...
  function calculateFutureValue(current, annualContribution, growthRate, netReturn, years, n) {
    ...
    if (annualContribution > 0) {
      // Sum contributions with growth year by year
  ...
  function calculateIRA(inputs) {
    ...
    // totalContributions includes current balance + all contributions
    ...
    for (var i = 0; i <= steps; i++) {
      ...
      // Partial year contribution adjustment
      if (t > 0) {
  ...
  function updateTool() {
    ...
    var result = calculateIRA(inputs);
    ...
    if (tab === 'growth') {
      ...
      return {
        ...
        options: {
          ...
          plugins: {
            legend: { position: 'top' },
            title: { display: true, text: 'IRA Growth Over Time', font: { size: 14 } }
          },
          scales: {
            y: {
              beginAtZero: true,
      ...
      return {
        ...
        options: {
          ...
          plugins: {
            ...
            title: { display: true, text: 'Breakdown of Final IRA Balance', font: { size: 14 } }
          },
          cutout: '60%'
        }
      };
