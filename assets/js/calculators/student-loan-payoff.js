...
(function() {
  ...
  // ── Reset Tool ──
  function resetTool() {
    document.getElementById('input_loanBalance').value = 30000;
    document.getElementById('input_interestRate').value = 6.0;
    document.getElementById('input_monthlyPayment').value = 350;
    document.getElementById('input_extraMonthlyPayment').value = 50;
