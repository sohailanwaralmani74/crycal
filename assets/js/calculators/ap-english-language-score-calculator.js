(function() {
  ...
  function calculateScore(inputs) {
    ...
    var composite = Math.round((mcq / 45) * 45 + (frq / 18) * 55);
    var apGrade = 1;
    ...
    else if (composite >= 61) { apGrade = 4; statusText = 'Qualified for Credit (Grade 4 - Well Qualified)'; }
    else if (composite >= 50) { apGrade = 3; statusText = 'Qualified for Credit (Grade 3 - Qualified)'; }
    else if (composite >= 38) { apGrade = 2; statusText = 'No Credit (Grade 2 - Possibly Qualified)'; }
