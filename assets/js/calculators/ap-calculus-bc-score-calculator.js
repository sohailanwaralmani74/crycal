(function() {
  ...
  function calculateScore(inputs) {
    ...
    if (composite >= 65) { apGrade = 5; statusText = 'Qualified for Credit (Grade 5 - Extremely Well Qualified)'; }
    else if (composite >= 53) { apGrade = 4; statusText = 'Qualified for Credit (Grade 4 - Well Qualified)'; }
    else if (composite >= 39) { apGrade = 3; statusText = 'Qualified for Credit (Grade 3 - Qualified)'; }
    else if (composite >= 27) { apGrade = 2; statusText = 'No Credit (Grade 2 - Possibly Qualified)'; }
