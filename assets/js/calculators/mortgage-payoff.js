...
(function() {
  ...
  function generateChartData(tab, result, inputs) {
    ...
    if (tab === 'comparison') {
      ...
      // Use every 6th point for performance
      var step = 1;
      ...
      return {
        ...
        options: {
          ...
          plugins: {
            legend: { position: 'top' },
            title: { display: true, text: 'Mortgage Balance Over Time', font: { size: 14 } }
          },
          scales: {
            y: {
              beginAtZero: true,
    ...
    if (tab === 'timeline') {
      ...
      // Use the last point
      var origLast = origSchedule[origSchedule.length - 1];
      var newLast = newSchedule[newSchedule.length - 1];
