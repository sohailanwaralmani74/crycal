(function() {
  ...
  function calculateScore(inputs) {
    ...
    if (composite >= 71) { apGrade = 5; statusText = 'Qualified for Credit (Grade 5 - Extremely Well Qualified)'; }
    else if (composite >= 59) { apGrade = 4; statusText = 'Qualified for Credit (Grade 4 - Well Qualified)'; }
