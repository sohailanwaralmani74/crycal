---
layout: tool
title: "AP Statistics Score Calculator | Predict Your AP Stat Score"
description: "Calculate your AP Statistics exam grade (1–5) based on 40 MCQ items and 6 free-response questions including the investigative task."
permalink: /ap-statistics-score-calculator
tool_id: ap-statistics-score-calculator
category: ap-scores
hide_sidebar: true
...
inputs:
  - id: mcq
    ...
    placeholder: "e.g., 28"
  - id: frq
    label: "Free Response Points (out of 24)"
    type: number
    default: 16
    min: 0
    max: 24
...
js_file: assets/js/calculators/ap-statistics-score-calculator.js
...
howto:
  name: "How to Calculate Your AP Statistics AP Score"
  description: "Use your section scores to estimate your official 1-5 AP score for AP Statistics."
  step:
...
faq:
  - question: "How is the AP Statistics AP score calculated?"
    answer: "The AP Statistics AP score combines your weighted Section 1 (Multiple-Choice) and Section 2 (Free-Response) points into a composite score out of 100. This composite score is mapped to a 1–5 AP grade based on College Board scoring curves."
...
# AP Statistics Score Calculator | Predict Your AP Stat Score

Calculate your AP Statistics exam grade (1–5) based on 40 MCQ items and 6 free-response questions including the investigative task. Calculate your composite score and see if you are on track for a 3, 4, or 5 — 100% free and private in your browser.

<!-- more -->

## How AP Statistics Exam Scoring Works

The **AP Statistics** exam consists of multiple sections that are weighted to produce a composite score out of **100**. College Board converts this composite score into a scaled AP score from **1 to 5**:

- **5 (Extremely Well Qualified)**: Composite score of 70+
- **4 (Well Qualified)**: Composite score of 57 – 69
- **3 (Qualified)**: Composite score of 44 – 56
- **2 (Possibly Qualified)**: Composite score of 31 – 43
- **1 (No Recommendation)**: Composite score of 0 – 30

## Section Weighting Breakdown

| Section | Format | Max Raw Points | Weight % | Max Composite Points |
|---|---|---|---|---|
| Section I | Multiple Choice (40 Questions) | 40 | 50% | 50 |
| Section II | Free Response (6 Questions) | 24 | 50% | 50 |
...
### How is the AP Statistics AP score calculated?
The AP Statistics AP exam score combines your weighted Multiple-Choice and Free-Response section points into a total composite score out of 100, which maps to a 1–5 AP grade based on College Board scoring curves.
