---
layout: tool
title: "AP Macroeconomics Score Calculator | Estimate AP Macro Grade"
description: "Calculate your AP Macroeconomics composite score and 1–5 grade based on 60 MCQ questions and 3 FRQ questions."
permalink: /ap-macroeconomics-score-calculator
tool_id: ap-macroeconomics-score-calculator
category: ap-scores
hide_sidebar: true
...
inputs:
  - id: mcq
    ...
    placeholder: "e.g., 44"
  - id: frq
    label: "Free Response Points (out of 20)"
    type: number
    default: 14
    min: 0
    max: 20
...
outputs:
  ...
  - id: compositeScore
    label: "Total Composite Points (out of 90)"
  - id: scoreStatus
...
js_file: assets/js/calculators/ap-macroeconomics-score-calculator.js
...
breadcrumb:
  ...
  - name: Education
    url: /education
  - name: "AP Macroeconomics Calculator"

howto:
  name: "How to Calculate Your AP Macroeconomics AP Score"
  description: "Use your section scores to estimate your official 1-5 AP score for AP Macroeconomics."
  step:
...
faq:
  - question: "How is the AP Macroeconomics AP score calculated?"
    answer: "The AP Macroeconomics AP score combines your weighted Section 1 (Multiple-Choice) and Section 2 (Free-Response) points into a composite score out of 90. This composite score is mapped to a 1–5 AP grade based on College Board scoring curves."
...
# AP Macroeconomics Score Calculator | Estimate AP Macro Grade

Calculate your AP Macroeconomics composite score and 1–5 grade based on 60 MCQ questions and 3 FRQ questions. Calculate your composite score and see if you are on track for a 3, 4, or 5 — 100% free and private in your browser.

<!-- more -->

## How AP Macroeconomics Exam Scoring Works

The **AP Macroeconomics** exam consists of multiple sections that are weighted to produce a composite score out of **90**. College Board converts this composite score into a scaled AP score from **1 to 5**:

- **5 (Extremely Well Qualified)**: Composite score of 68+
- **4 (Well Qualified)**: Composite score of 55 – 67
- **3 (Qualified)**: Composite score of 42 – 54
- **2 (Possibly Qualified)**: Composite score of 30 – 41
...
|---|---|---|---|---|
| Section I | Multiple Choice (60 Questions) | 60 | 66.7% | 60 |
| Section II | Free Response (3 Questions) | 20 | 33.3% | 30 |
...
### How is the AP Macroeconomics AP score calculated?
The AP Macroeconomics AP exam score combines your weighted Multiple-Choice and Free-Response section points into a total composite score out of 90, which maps to a 1–5 AP grade based on College Board scoring curves.
