...
# CD Calculator – See Exactly What Your Certificate of Deposit Will Earn

Thinking about locking in a guaranteed return with a CD? Our **CD Calculator** takes the guesswork out of the equation—showing you exactly how much your money will grow by the time your CD matures. Whether you're planning a short-term 3-month CD or a long-term 5-year CD, you'll get clear, accurate projections in seconds.

<!-- more -->

## How This CD Interest Calculator Works

A **certificate of deposit (CD)** is one of the safest ways to save—you lock your money for a fixed term, and the bank pays you a guaranteed interest rate. No market swings, no surprises. Just steady, predictable growth.

Our **CD interest calculator** gives you:

- **Maturity Value** — your final balance when the CD matures
- **Total Interest Earned** — exactly how much your money grew
- **Annual Percentage Yield (APY)** — your true annual return including compounding
- **Growth Chart** — a month-by-month visual of your CD's journey

It works for **any CD account**—3-month, 6-month, 9-month, 12-month, or even a 5-year CD. Just plug in your numbers and see the results.

---

## The Simple Math Behind Your CD

Every bank uses the same compound interest formula. Here's how it works:
...
*This is why a 5% APR compounded daily gives you a higher APY than 5% compounded annually. Our calculator shows you this difference instantly.*
...
| **Total Interest** | **$265.26** |
| **APY** | **5.38%** |

### Example 2: 12-Month CD (Most Popular)
...
| **Total Interest** | **$12,458.12** |
| **APY** | **4.58%** |

### Example 4: 3-Month CD (Ladder Starter)
...
Getting your CD projection is quick and straightforward:

1. **Enter your initial deposit** — how much you're investing.
2. **Set the CD term** — enter any length in months (3, 6, 9, 12, 24, 36, 48, 60, or more).
3. **Enter the interest rate (APR)** — the rate your bank is offering.
4. **Choose compounding frequency** — daily, monthly, quarterly, semi-annually, or annually.
5. **Review your results instantly** — maturity value, total interest, APY, and a growth chart.

---

## CD Ladder Strategy – Build Your Own

A **CD ladder** is a smart strategy where you spread your savings across multiple CDs with different maturity dates. For example:
...
**How this tool helps:** While this is a single-CD calculator, you can run it multiple times—once for each rung of your ladder. This lets you design your ideal CD ladder, balancing liquidity and yield.
...
It's a tool that estimates the maturity value and total interest earned on a certificate of deposit based on your principal, term, interest rate, and compounding frequency. It helps you figure out your returns before you open an account.

### What's the formula for a certificate of deposit?

**A = P × (1 + r/n)^(n×t)** — where A is the maturity value, P is your principal, r is the annual interest rate, n is the number of compounding periods per year, and t is the term in years.

### How do I calculate APY for a CD?

**APY = (1 + r/n)^n – 1** — this shows your true annual return including compounding. Our calculator does this automatically.

### What's a CD ladder and how does it work?

A CD ladder is a strategy where you stagger CD maturities across different terms. For example, instead of putting all your money into one 5-year CD, you might split it across 3-month, 6-month, 9-month, and 12-month CDs. This way, you have regular access to a portion of your funds while earning higher yields on longer-term CDs.

### What's the difference between APR and APY?

- **APR (Annual Percentage Rate)** — the stated interest rate without compounding.
- **APY (Annual Percentage Yield)** — the true return including compounding.

APY is always higher than APR when compounding occurs—and our calculator shows you both.

### Does compounding frequency matter?

Yes! More frequent compounding = higher returns. A CD compounded daily will earn more than the same rate compounded monthly or annually. Our calculator lets you compare all five frequencies side-by-side.

### Can I use this for high-yield CDs?

Absolutely. Enter any rate—our calculator works for standard CDs, high-yield CDs, or any certificate of deposit offered by any bank or credit union.

### Is this CD calculator free?

**Yes.** Completely free, no registration required, and no hidden fees. All calculations run locally in your browser—your data stays private.

---

> **📊 Quick Tip:** If you're building a CD ladder, try running the calculator for each rung separately. You'll get a clear picture of your total returns and exactly when each portion of your savings will become available.
